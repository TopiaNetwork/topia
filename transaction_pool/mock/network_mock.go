...
func (m *MockNetwork) CreateTopic(topic string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CreateTopic", topic)
}

// CreateTopic indicates an expected call of CreateTopic.
func (mr *MockNetworkMockRecorder) CreateTopic(topic interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTopic", reflect.TypeOf((*MockNetwork)(nil).CreateTopic), topic)
}
...
// UpdateNetActiveNode mocks base method.
func (m *MockNetwork) UpdateNetActiveNode(netActiveNode common.NetworkActiveNode) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "UpdateNetActiveNode", netActiveNode)
}

// UpdateNetActiveNode indicates an expected call of UpdateNetActiveNode.
func (mr *MockNetworkMockRecorder) UpdateNetActiveNode(netActiveNode interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNetActiveNode", reflect.TypeOf((*MockNetwork)(nil).UpdateNetActiveNode), netActiveNode)
}
