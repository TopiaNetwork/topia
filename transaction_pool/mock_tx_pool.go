...
func (m *MockTransactionPool) Pending() ([]*basic.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockTransactionPool) PickTxs(txType PickTxType) []*basic.Transaction {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PickTxs", txType)
	ret0, _ := ret[0].([]*basic.Transaction)
	return ret0
}

// PickTxs indicates an expected call of PickTxs.
func (mr *MockTransactionPoolMockRecorder) PickTxs(txType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PickTxs", reflect.TypeOf((*MockTransactionPool)(nil).PickTxs), txType)
}
...
func (m *MockTransactionPool) RemoveTxHashs(hashs []string) []error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RemoveTxHashs", hashs)
	ret0, _ := ret[0].([]error)
	return ret0
}

// RemoveTxHashs indicates an expected call of RemoveTxHashs.
func (mr *MockTransactionPoolMockRecorder) RemoveTxHashs(hashs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveTxHashs", reflect.TypeOf((*MockTransactionPool)(nil).RemoveTxHashs), hashs)
}
