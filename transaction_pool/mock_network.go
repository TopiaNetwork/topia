...
func (m *MockNetwork) Publish(ctx context.Context, toModuleName, topic string, data []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Publish", ctx, toModuleName, topic, data)
	ret0, _ := ret[0].(error)
	return ret0
}

// Publish indicates an expected call of Publish.
func (mr *MockNetworkMockRecorder) Publish(ctx, toModuleName, topic, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockNetwork)(nil).Publish), ctx, toModuleName, topic, data)
}
