...
func TestSend(t *testing.T) {
	...
	p2p1 := NewP2PService(context.Background(), testLog, nil, "/ip4/127.0.0.1/tcp/41000", "topia1")

	testLog.Infof("p2p1 id=%s", p2p1.ID().String())

	p2p2 := NewP2PService(context.Background(), testLog, nil, "/ip4/127.0.0.1/tcp/41001", "topia2")
