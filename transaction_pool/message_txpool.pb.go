...
var fileDescriptor_9a7af56e6334bfec = []byte{
	...
	,
}
...
func (m *TxPoolMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FromNode) > 0 {
		...
		i = encodeVarintMessageTxpool(dAtA, i, uint64(len(m.FromNode)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.FromDomain) > 0 {
		i -= len(m.FromDomain)
		copy(dAtA[i:], m.FromDomain)
		i = encodeVarintMessageTxpool(dAtA, i, uint64(len(m.FromDomain)))
		i--
		dAtA[i] = 0x12
	}
	if m.MsgType != 0 {
...
func (m *TxPoolMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FromDomain", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FromDomain = append(m.FromDomain[:0], dAtA[iNdEx:postIndex]...)
			if m.FromDomain == nil {
				m.FromDomain = []byte{}
			}
			iNdEx = postIndex
		case 3:
			...
			m.FromNode = append(m.FromNode[:0], dAtA[iNdEx:postIndex]...)
			if m.FromNode == nil {
				m.FromNode = []byte{}
			}
			iNdEx = postIndex
