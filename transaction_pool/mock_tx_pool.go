...
func (m *MockTransactionPool) AddTx(tx *basic.Transaction, local bool) error {
	m.ctrl.T.Helper()
...
func (m *MockTransactionPool) Pending(category basic.TransactionCategory) map[types0.Address][]*basic.Transaction {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Pending", category)
	ret0, _ := ret[0].(map[types0.Address][]*basic.Transaction)
	return ret0
}

// Pending indicates an expected call of Pending.
func (mr *MockTransactionPoolMockRecorder) Pending(category interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Pending", reflect.TypeOf((*MockTransactionPool)(nil).Pending), category)
}

// PickTxs mocks base method.
func (m *MockTransactionPool) PickTxs(category basic.TransactionCategory, txsType int) []*basic.Transaction {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PickTxs", category, txsType)
	ret0, _ := ret[0].([]*basic.Transaction)
	return ret0
}

// PickTxs indicates an expected call of PickTxs.
func (mr *MockTransactionPoolMockRecorder) PickTxs(category, txsType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PickTxs", reflect.TypeOf((*MockTransactionPool)(nil).PickTxs), category, txsType)
}
...
func (m *MockTransactionPool) UpdateTx(tx *basic.Transaction, txKey string) error {
	m.ctrl.T.Helper()
