...
type TransactionUniversalVerifier func(ctx context.Context, log tplog.Logger, txUni *TransactionUniversalWithHead, txUniServant TransactionUniversalServant) txbasic.VerifyResult

func TransactionUniversalPayerAddressVerifier() TransactionUniversalVerifier {
	return func(ctx context.Context, log tplog.Logger, txUni *TransactionUniversalWithHead, txUniServant TransactionUniversalServant) txbasic.VerifyResult {
...
func ApplyTransactionUniversalVerifiers(ctx context.Context, log tplog.Logger, txUni *TransactionUniversalWithHead, txUniServant TransactionUniversalServant, verifiers ...TransactionUniversalVerifier) txbasic.VerifyResult {
